define(['indexApp', 'Extend', 'highcharts', 'common/util', 'model/consultStatisticModel', 'hcexporting', 'hcexportingcsv', 'pikaday', 'service/baseService', 'jQueryUi', 'timePicker'],
 function (app, Extend, highcharts, util, consultStatisticModel, exporting, exportCSV, pikaday) {
