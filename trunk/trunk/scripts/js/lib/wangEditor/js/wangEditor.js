...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        // UI
        // var $uploadIcon = $('<div class="upload-icon-container"><i class="wangeditor-menu-img-upload"><div style="display:none;"><input type="file" class="uploadImageToYouPai"/></div></i></div>');
        var $uploadIcon = $('<div class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></div>');
        $uploadContent.append($uploadIcon);
